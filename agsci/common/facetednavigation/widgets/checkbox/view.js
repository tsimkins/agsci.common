/* Checkboxes Widget
*/
Faceted.CheckboxesDegreeExplorerWidget = function(wid){
  var self = this;
  this.wid = wid;
...
Faceted.CheckboxesDegreeExplorerWidget.prototype = {
  ...
  criteria_body: function(){
    ...
    widget.selected.each(function(i){
      ...
      var link = jQuery('<button class="btn btn-light-creek-outline">' + title + ' <i class="fas fa-times-circle"></i></button>');
  ...
  count_update: function(data, sortcountable){
    var context = this;
    var lis = jQuery('div.checkbox', context.widget);
...
Faceted.initializeCheckboxesDegreeExplorerWidget = function(evt){
  jQuery('div.faceted-checkbox_degree_explorer-widget').each(function(){
    var wid = jQuery(this).attr('id');
    wid = wid.split('_')[0];
    Faceted.Widgets[wid] = new Faceted.CheckboxesDegreeExplorerWidget(wid);
  });
};
...
jQuery(document).ready(function(){
  jQuery(Faceted.Events).bind(
    ...
    Faceted.initializeCheckboxesDegreeExplorerWidget);
});
