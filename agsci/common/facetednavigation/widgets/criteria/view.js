/* Criteria Widget
*/
Faceted.CriteriaDegreeExplorerWidget = function(wid){
  this.wid = wid;
  this.widget = jQuery('#' + wid + '_widget');
  this.title = jQuery('.active-filters', this.widget).html();
...
Faceted.CriteriaDegreeExplorerWidget.prototype = {
...
Faceted.initializeCriteriaDegreeExplorerWidget = function(evt){
  jQuery('div.faceted-criteria_degree_explorer-widget').each(function(){
    var wid = jQuery(this).attr('id');
    wid = wid.split('_')[0];
    Faceted.Widgets[wid] = new Faceted.CriteriaDegreeExplorerWidget(wid);
  });
};
...
jQuery(document).ready(function(){
  jQuery(Faceted.Events).bind(
    ...
    Faceted.initializeCriteriaDegreeExplorerWidget);
});
